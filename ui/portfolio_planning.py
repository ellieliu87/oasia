...
def _scenario_html(s: dict, recommended: bool) -> str:
    ...
    return (
        ...
        f'<div style="font-size:12px;font-family:var(--mono);color:#CBD5E1;line-height:1.9;">'
        ...
        f'<span style="color:#475569;">──────────────────────</span><br>'
        ...
        f'</div>'
        f'<div style="font-size:11px;color:#64748B;margin-top:8px;font-style:italic;line-height:1.4;">'
